...
const DEFAULTS = {
  ...
  txtTgUrl:'https://t.me/aeterna_lead_bot',
  ...
  /* Только основное, без допов вроде «одна страница» или «мини-приложение» —
     список в заявке короткий нарочно, чтобы человек выбирал по смыслу
     задачи, а не разбирался в разнице форматов до разговора со мной. */
  txtCtKinds:'Сайт с нуля|Авторский|Редизайн|Бот в телеграме|Приглашение на свадьбу|Пока не знаю',
